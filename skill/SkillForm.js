...
setItem = null;
var MST_Skill_List = [
["攻撃系",[161/*剛撃*/,21/*攻撃*/,155/*一匹狼*/,169/*一閃*/,18/*達人*/,205/*閃転*/,173/*痛撃*/,207/*巧撃*/,197/*属撃*/,202/*変撃*/,190/*劇物の心得*/,47/*特殊攻撃*/,220/*怪奇*/,111/*火属性攻撃*/,112/*水属性攻撃*/,113/*雷属性攻撃*/,114/*氷属性攻撃*/,115/*龍属性攻撃*/,142/*属性攻撃*/,50/*爆弾強化*/,81/*砲術師*/,162/*鼓舞*/,85/*笛吹き名人*/,91/*体術*/,170/*逆境*/,165/*怒*/,65/*底力*/,217/*腕利き*/,222/*手練*/,116/*断食*/,128/*溜め短縮*/,179/*溜め威力*/,141/*武器捌き*/,154/*尻上がり*/,184/*適応撃*/,198/*闘覇*/,199/*血気活性*/,201/*纏雷*/,210/*贅撃*/,214/*雌伏*/,216/*猛進*/,218/*幕無*/,219/*一点突破*/,223/*獅子奮迅*/,206/*不退*/]],
["防御系",[164/*生命力*/,157/*反射*/,56/*防御*/,212/*要塞*/,5/*ガード性能*/,4/*自動防御*/,90/*とんずら*/]],
["体力・スタミナ系",[31/*体力*/,7/*回復速度*/,6/*回復*/,183/*吸血*/,186/*薬草学*/,143/*気力回復*/,51/*はらへり*/,67/*スタミナ*/,71/*食事*/,16/*食いしん坊*/]],
["剣士系",[45/*研ぎ師*/,15/*斬れ味*/,194/*巧流*/,159/*刀匠*/,32/*匠*/,118/*爆撃剣*/,120/*猛毒剣*/,121/*麻痺剣*/,122/*睡眠剣*/,123/*火炎剣*/,124/*水激剣*/,125/*雷神剣*/,126/*氷結剣*/,127/*龍王剣*/,129/*片手剣技*/,130/*双剣技*/,131/*大剣技*/,132/*太刀技*/,133/*鎚技*/,134/*狩猟笛技*/,135/*槍技*/,136/*銃槍技*/,211/*剣斧技*/,187/*穿龍棍技*/,224/*磁斬鎚技*/,147/*剣術*/,200/*剣神*/]],
["ガンナー系",[171/*射手*/,38/*通常弾強化*/,11/*貫通弾強化*/,23/*散弾強化*/,39/*通常弾追加*/,12/*貫通弾追加*/,24/*散弾追加*/,60/*榴弾追加*/,8/*拡散弾追加*/,108/*毒瓶追加*/,109/*麻痺瓶追加*/,110/*睡眠瓶追加*/,172/*装着*/,196/*穏射*/,68/*装填数*/,160/*速射*/,62/*連射*/,28/*装填*/,52/*反動*/,176/*扇射*/,69/*精密射撃*/,34/*弾調合*/,180/*弾丸節約術*/,213/*狙撃*/,221/*空隙*/,137/*重銃技*/,138/*軽銃技*/,139/*弓技*/]],
["状態異常系",[46/*毒*/,57/*麻痺*/,25/*睡眠*/,148/*耐状態異常*/,13/*気絶*/,74/*脱臭*/,75/*耐雪*/,79/*声帯*/,146/*対防御DOWN*/,149/*耐酔*/,204/*爆破耐性*/,151/*磁力耐性*/,150/*結晶耐性*/,208/*凍結耐性*/]],
["耐性系",[26/*全耐性ＵＰ*/,53/*火耐性*/,58/*水耐性*/,76/*氷耐性*/,10/*雷耐性*/,59/*龍耐性*/]],
["保護系",[156/*三界の護り*/,36/*聴覚保護*/,77/*耐震*/,54/*風圧*/,49/*盗み無効*/,30/*耐暑*/,29/*耐寒*/,152/*警戒*/,73/*地形*/,215/*超回避*/,64/*回避性能*/,178/*回避距離*/,95/*受け身*/,9/*審判*/,102/*根性*/,191/*絶対防御*/]],
["アイテム・調合系",[174/*調合師*/,66/*効果持続*/,78/*広域*/,14/*気まぐれ*/,44/*投擲*/,92/*強肩*/,175/*狩人*/,80/*肉焼き*/,40/*釣り*/,37/*調合成功率*/,61/*錬金術*/,140/*高速設置*/,166/*鉄腕*/,144/*ナイフ使い*/]],
["MAP探知系",[35/*地図*/,27/*千里眼*/,17/*気配*/,188/*煽動*/]],
["採取運搬系",[3/*運搬*/,63/*高速収集*/,22/*採取*/,72/*剥ぎ取り*/,192/*平常心*/]],
["報酬系",[2/*運気*/,70/*モンスター*/,104/*圧力*/]],
["その他系",[167/*ブリーダー*/,100/*絆*/,94/*ひらめき*/,105/*捕獲上手*/,153/*救援*/,145/*いたわり*/,181/*移動速度*/,182/*喝*/,195/*支援*/,163/*恩寵*/,158/*代償*/,185/*黒ノ命脈*/,189/*炎寵*/,203/*抜納術*/,209/*氷界創生*/]]];
var MST_Skill = [
["なし",	,,									],
["受身",	,,									],
["運気",	146,1,		,-20,161	,-10,160	,10,158	,20,159				],
["運搬",	132,,				,10,97					],
["自動防御",	108,,				,10,44					],
["ガード性能",	107,1,		,-15,43	,-10,42	,10,40	,20,41				],
["回復",	149,,			,-10,166	,10,165					],
["回復速度",	97,1,		,-20,30	,-10,29	,10,27	,20,28				],
["拡散弾追加",	121,,				,10,68	,15,69	,20,70			],
["審判",	128,1,		,-20,91	,-10,90	,10,88	,20,89				],
["雷耐性",	137,1,	,-20,127	,-15,126	,-10,125	,10,122	,15,123	,20,124			],
["貫通弾強化",	115,,				,10,55					],
["貫通弾追加",	118,,				,10,59	,15,60	,20,61			],
["気絶",	91,1,			,-10,9	,10,7	,20,8				],
["気まぐれ",	145,1,		,-15,157	,-10,156	,10,154	,15,155				],
["斬れ味",	99,1,			,-10,32	,10,31	,20,293				],
["食いしん坊",	125,,				,10,77	,15,78				],
["気配",	95,,			,-10,20	,10,19					],
["達人",	101,1,				,10,35	,15,36	,20,37	,35,284	,50,285	],
["広域回復",	,,									],
["広域解毒",	,,									],
["攻撃",	126,1,				,10,79	,15,80	,25,81	,50,286	,80,287	],
["採取",	143,1,		,-15,152	,-10,151	,10,149	,15,150				],
["散弾強化",	116,,				,10,56					],
["散弾追加",	119,,				,10,62	,15,63	,20,64			],
["睡眠",	90,1,			,-10,6	,10,4	,20,5				],
["全耐性ＵＰ",	133,,	,-20,103	,-15,102	,-10,101	,10,98	,15,99	,20,100			],
["千里眼",	148,1,				,10,163	,15,164				],
["装填",	110,1,			,-10,49	,10,46	,15,47	,20,48			],
["耐寒",	140,1,		,-20,143	,-10,142	,10,139	,15,141	,25,297			],
["耐暑",	139,1,		,-20,138	,-10,137	,10,134	,15,136	,25,296			],
["体力",	96,1,	,-20,26	,-15,25	,-10,24	,10,21	,15,22	,20,23	,30,291	,40,292	],
["匠",	100,,				,10,33					],
["種広域化",	,,									],
["弾調合",	151,,				,10,172					],
["地図",	142,,				,10,147					],
["聴覚保護",	129,1,				,10,92	,15,93	,25,288			],
["調合成功率",	150,1,			,-10,170	,10,167	,15,168	,20,169			],
["通常弾強化",	114,,				,10,54					],
["通常弾追加",	117,,					,15,58				],
["釣り",	147,,				,10,162					],
["------",	,,									],
...
["------",	,,									],
["投擲",	109,,				,10,45					],
["研ぎ師",	104,1,			,-10,39	,10,38	,20,398				],
["Poison",	92,1,			,-10,12	,10,10	,20,11				],
["特殊攻撃",	122,,				,10,71					],
["肉",	,,									],
["盗み無効",	130,,				,10,94					],
["爆弾強化",	123,,				,10,72					],
["はらへり",	124,1,		,-15,76	,-10,75	,10,73	,15,74				],
["反動",	113,1,				,10,52	,15,53	,20,482			],
["火耐性",	134,1,	,-20,109	,-15,108	,-10,107	,10,104	,15,105	,20,106			],
["風圧",	141,1,				,10,144	,15,145	,20,146	,30,349		],
["笛",	,,									],
["防御",	127,1,	,-20,87	,-15,86	,-10,85	,10,82	,15,83	,25,84	,35,294	,45,295	],
["麻痺",	89,1,			,-10,3	,10,1	,20,2				],
["水耐性",	135,1,	,-20,115	,-15,114	,-10,113	,10,110	,15,111	,20,112			],
["龍耐性",	138,1,	,-20,133	,-15,132	,-10,131	,10,128	,15,129	,20,130			],
["榴弾追加",	120,,				,10,65	,15,66	,20,67			],
["錬金術",	152,,				,10,173					],
["連射",	112,,				,10,51					],
["高速収集",	144,,				,10,153					],
["回避性能",	154,1,				,10,177	,20,178				],
["底力",	155,,			,-15,181	,10,179	,15,180	,21,179	,30,181		],
["効果持続",	156,,			,-10,183	,10,182					],
["スタミナ",	157,1,			,-10,185	,10,184	,20,289				],
["装填数",	158,,				,10,186					],
["精密射撃",	159,1,			,-10,188	,10,187	,20,290				],
["モンスター",	160,,				,10,189					],
["食事",	161,,			,-10,191	,10,190					],
["剥ぎ取り",	162,,				,15,192					],
["地形",	163,1,		,-15,196	,-10,195	,10,193	,15,194				],
["脱臭",	93,,				,10,14					],
["耐雪",	94,,				,10,17					],
["氷耐性",	136,1,	,-20,121	,-15,120	,-10,119	,10,116	,15,117	,20,118			],
["耐震",	164,1,				,15,197	,25,350				],
["広域",	131,1,			,-10,385	,10,95	,20,96	,30,384			],
["声帯",	165,1,				,10,198	,15,199				],
["肉焼き",	166,1,			,-10,202	,10,200	,15,201				],
["砲術師",	167,1,				,10,203	,20,298	,35,299			],
...
["------",	175,,				,10,217					],
["とんずら",	176,,				,10,218					],
["体術",	177,1,				,10,219	,20,359				],
["強肩",	178,1,				,10,220	,20,360				],
["------",	179,,				,10,221					],
["ひらめき",	180,,				,10,222					],
["受け身",	181,,				,10,223					],
["------",	182,,				,10,224					],
...
["絆",	186,,				,10,228					],
["------",	187,,				,10,229					],
["根性",	82,1,				,10,230	,20,231	,30,232			],
["------",	188,,				,10,233					],
["圧力",	189,1,				,10,234	,20,300				],
["捕獲上手",	190,1,				,10,235	,20,301				],
["------",	191,,				,10,236					],
["------",	192,,				,10,237					],
["毒瓶追加",	193,,				,10,238					],
["麻痺瓶追加",	194,,				,10,239					],
["睡眠瓶追加",	195,,				,10,240					],
["火属性攻撃",	196,1,				,10,241	,20,242				],
["水属性攻撃",	197,1,				,10,243	,20,244				],
["雷属性攻撃",	198,1,				,10,245	,20,246				],
["氷属性攻撃",	199,1,				,10,247	,20,248				],
["龍属性攻撃",	200,1,				,10,249	,20,250				],
["断食",	201,,				,10,251		,20,252			],
["----",	202,,				,10,253					],
["爆撃剣",	203,1,				,10,254	,15,255	,20,256			],
["強撃剣",	204,,				,10,257	,15,258	,20,259			],
["猛毒剣",	205,1,				,10,260	,15,261	,20,262			],
["麻痺剣",	206,1,				,10,263	,15,264	,20,265			],
["睡眠剣",	207,1,				,10,266	,15,267	,20,268			],
["火炎剣",	208,1,				,10,269	,15,270	,20,271			],
["水激剣",	209,1,				,10,272	,15,273	,20,274			],
["雷神剣",	210,1,				,10,278	,15,279	,20,280			],
["氷結剣",	211,1,				,10,275	,15,276	,20,277			],
["龍王剣",	212,1,				,10,281	,15,282	,20,283			],
["溜め短縮",	213,1,			,-10,304	,10,303	,20,302				],
["片手剣技",	1,,2			,-10,308	,10,307	,20,306	,30,305			],
["双剣技",	2,,2			,-10,312	,10,311	,20,310	,30,309			],
["大剣技",	3,,2			,-10,316	,10,315	,20,314	,30,313			],
["太刀技",	4,,2			,-10,320	,10,319	,20,318	,30,317			],
["鎚技",	5,,2			,-10,324	,10,323	,20,322	,30,321			],
["狩猟笛技",	6,,2			,-10,328	,10,327	,20,326	,30,325			],
["槍技",	7,,2			,-10,332	,10,331	,20,330	,30,329			],
["銃槍技",	8,,2			,-10,336	,10,335	,20,334	,30,333			],
["重銃技",	12,,2			,-10,340	,10,339	,20,338	,30,337			],
["軽銃技",	13,,2			,-10,344	,10,343	,20,342	,30,341			],
["弓技",	14,,2			,-10,348	,10,347	,20,346	,30,345			],
["高速設置",	83,1,				,10,351	,20,352				],
["武器捌き",	79,,				,10,353					],
["属性攻撃",	80,,			,-10,355	,10,354					],
["気力回復",	81,1,			,-10,358	,10,357	,20,356				],
["ナイフ使い",	86,1,				,10,361	,20,362				],
["いたわり",	87,,				,10,363	,15,364	,25,365			],
["対防御DOWN",	88,,				,10,366					],
["剣術",	85,1,				,10,367	,20,368				],
["耐状態異常",	84,1,			,-10,371	,10,369	,20,370	,30,491			],
["耐酔",	51,,1			,-10,387	,10,386					],
["結晶耐性",	53,,1			,-10,389	,10,388					],
["磁力耐性",	54,,1			,-10,391	,10,390					],
["警戒",	41,,1				,10,392					],
["救援",	49,,1				,10,393					],
["尻上がり",	39,,1				,15,394					],
["一匹狼",	40,,1				,10,395					],
["三界の護り",	30,,1				,10,399	,15,400	,20,401			],
["反射",	31,,1				,10,402	,15,403	,20,404	,16384,518		],
["代償",	28,,1				,10,396					],
["刀匠",	25,,1				,10,405	,15,406	,20,407			],
["速射",	29,,1				,15,397					],
["剛撃",	16,,1			,10,408	,15,409	,20,410	,30,411	,40,412	,50,524	],
["鼓舞",	33,,1				,10,413	,20,414	,16384,517			],
["恩寵",	23,,1				,10,415	,20,416	,30,417			],
["生命力",	42,,1			,-10,421	,10,418	,15,419	,30,420			],
["怒",	45,,1				,15,422	,20,423				],
["鉄腕",	46,,1				,10,424	,20,425				],
["ブリーダー",	47,,1				,10,426					],
["相討ち",	78,,				,10,427	,20,428				],
["一閃",	17,,1				,10,429	,20,430	,30,431			],
["逆境",	48,,1				,10,432	,20,433				],
["射手",	34,,1				,15,434	,20,526				],
["装着",	35,,1				,10,435	,15,436	,20,437			],
["痛撃",	19,,1			,-10,440	,15,439					],
["調合師",	38,,1			,-10,444	,10,441	,15,442	,20,443			],
["狩人",	50,,				,10,445	,20,446				],
["扇射",	26,,1				,10,447	,15,448	,20,449			],
["連撃(削除)",	,,									],
["回避距離",	56,,1				,10,457					],
["溜め威力",	57,,1				,10,455	,20,456				],
["弾丸節約術",	58,,1				,10,453	,20,454				],
["移動速度",	59,,1				,10,451	,20,452				],
["喝",	60,,1			,-10,459	,10,458					],
["吸血",	61,,1				,10,460	,20,461				],
["適応撃",	62,,				,10,462	,20,463				],
["黒ノ命脈",	65,,1				,20,464					],
["薬草学",	66,,1				,10,465					],
["穿龍棍技",	10,,2			,-10,469	,10,468	,20,467	,30,466			],
["煽動",	67,,				,10,471					],
["炎寵",	68,,1				,10,472	,15,473				],
["劇物の心得",	70,,1				,10,474					],
["絶対防御",	74,,						,20,475			],
["平常心",	77,1,			,-10,478	,10,477	,15,476				],
["採集の極み",	,,									],
["巧流",	73,,1				,15,480					],
["支援",	75,,				,10,481					],
["穏射",	36,,1				,10,483	,15,484	,20,485			],
["属撃",	20,,1			,-10,487	,10,486					],
["闘覇",	76,,				,10,488					],
["血気活性",	64,,				,10,489					],
["剣神",	24,,1				,10,492	,20,493	,25,525			],
["纏雷",	21,,1				,10,494					],
["変撃",	71,,				,10,495					],
["抜納術",	32,,1				,10,496	,15,497				],
["爆破耐性",	52,,				,10,498					],
["閃転",	102,,1				,10,499					],
["不退",	15,,1				,10,501					],
["巧撃",	72,,1				,15,502					],
...
["氷界創生",	63,,				,10,504					],
["贅撃",	98,,1				,10,505					],
["剣斧技",	9,,2			,-10,509	,10,508	,20,507	,30,506			],
["要塞",	106,,1				,10,511	,15,512				],
["狙撃",	111,,1				,10,513					],
["雌伏",	105,,1				,10,514					],
["超回避",	153,,					,15,515				],
["猛進",	22,,1				,10,516					],
...
["手練",	44,,				,10,527	,15,528				],
["獅子奮迅",	18,,				,10,529					],
["磁斬鎚技",	11,,2			,-10,533	,10,532	,20,531	,30,530			]
];
MST_Skill[""] = [""];
MST_Skill["-"] = [""];
var MST_Skill_Exe = [
"スキル無し","麻痺半減","麻痺無効","麻痺倍加","睡眠半減","睡眠無効","睡眠倍加","気絶確率半減","気絶無効","気絶倍加","毒半減","毒無効","毒倍加","脱臭","脱臭","------","耐雪","耐雪","------","隠密","挑発","体力+10","体力+20","体力+30","体力-10","体力-20","体力-30","ダメージ回復速度+1","ダメージ回復速度+2","ダメージ回復速度-1","ダメージ回復速度-2","業物+1","なまくら","斬れ味レベル+1","------","見切り+1","見切り+2","見切り+3","砥石使用高速化","砥石性能半減","ガード性能+1","ガード性能+2","ガード性能-1","ガード性能-2","オートガード","投擲技術UP","装填速度+1","装填速度+2","装填速度+3","装填速度-1","------","連射","反動軽減+1","反動軽減+2","通常弾・連射矢威力UP","貫通弾・貫通矢威力UP","散弾・拡散矢威力UP","通常弾ＬＶ１追加","通常弾全レベル追加","貫通弾ＬＶ１追加","貫通弾ＬＶ1&2追加","貫通弾全レベル追加","散弾ＬＶ１追加","散弾ＬＶ1&2追加","散弾全レベル追加","徹甲榴弾ＬＶ１追加","徹甲榴弾ＬＶ1&2追加","徹甲榴弾全レベル追加","拡散弾ＬＶ１追加","拡散弾ＬＶ1&2追加","拡散弾全レベル追加","状態異常攻撃強化","ボマー","はらへり半減","はらへり無効","はらへり倍加【小】","はらへり倍加【大】","まんぷく","拾い食い","攻撃力UP【小】","攻撃力UP【中】","攻撃力UP【大】","防御+20","防御+30","防御+60","防御-20","防御-30","防御-40","女神の赦し","女神の抱擁","死神の裁き","死神の抱擁","耳栓","高級耳栓","盗み無効","広域化+1","広域化+2","運搬の達人","各耐性+5","各耐性+10","各耐性+20","各耐性-5","各耐性-10","各耐性-20","火耐性+10","火耐性+20","火耐性+30","火耐性-10","火耐性-20","火耐性-30","水耐性+10","水耐性+20","水耐性+30","水耐性-10","水耐性-20","水耐性-30","氷耐性+10","氷耐性+20","氷耐性+30","氷耐性-10","氷耐性-20","氷耐性-30","雷耐性+10","雷耐性+20","雷耐性+30","雷耐性-10","雷耐性-20","雷耐性-30","龍耐性+10","龍耐性+20","龍耐性+30","龍耐性-10","龍耐性-20","龍耐性-30","暑さ半減","暑さ無効","暑さ無効","暑さ倍加【小】","暑さ倍加【大】","寒さ半減","寒さ無効","寒さ無効","寒さ倍加【小】","寒さ倍加【大】","風圧【小】無効","風圧【大】無効","龍風圧無効","地図常備","------","採取+1","採取+2","採取-1","採取-2","高速剥ぎ取り＆採取","精霊の気まぐれ","神の気まぐれ","悪霊の気まぐれ","悪魔の気まぐれ","幸運","激運","不運","災難","釣り名人","探知","自動マーキング","体力回復アイテム強化","体力回復アイテム弱化","調合成功率+10%","調合成功率+15%","調合成功率+30%","調合成功率-5%","調合成功率-15%","最大数弾生産","錬金術","------","------","------","回避性能+1","回避性能+2","火事場力+1","火事場力+2","心配性","アイテム使用強化","アイテム使用弱化","ランナー","鈍足","装填数UP","ぶれ幅DOWN","ぶれ幅UP","でかいの来い！","早食い","スローライフ","剥ぎ取り名人","地形ダメージ減【小】","地形ダメージ減【大】","地形ダメージ増【小】","地形ダメージ増【大】","耐震+1","声帯麻痺毒半減","声帯麻痺毒無効","焼き名人","焼き師匠","自称・焼き名人","砲術師","------","------","------","------","------","------","------","------","笛吹き名人","------","------","------","------","------","とんずら","体術","強肩+1","------","ひらめき","受け身","------","------","------","------","絆","------","根性","ド根性","真根性","------","圧力【小】","捕獲上手","------","------","毒ビン追加","麻痺ビン追加","睡眠ビン追加","火属性攻撃強化【小】","火属性攻撃強化【大】","水属性攻撃強化【小】","水属性攻撃強化【大】","雷属性攻撃強化【小】","雷属性攻撃強化【大】","氷属性攻撃強化【小】","氷属性攻撃強化【大】","龍属性攻撃強化【小】","龍属性攻撃強化【大】","餓狼+1","餓狼+2","--------","爆撃剣+1","爆撃剣+2","爆撃剣+3","強撃剣+1","強撃剣+2","強撃剣+3","猛毒剣+1","猛毒剣+2","猛毒剣+3","麻痺剣+1","麻痺剣+2","麻痺剣+3","睡眠剣+1","睡眠剣+2","睡眠剣+3","火炎剣+1","火炎剣+2","火炎剣+3","水激剣+1","水激剣+2","水激剣+3","氷結剣+1","氷結剣+2","氷結剣+3","雷神剣+1","雷神剣+2","雷神剣+3","龍王剣+1","龍王剣+2","龍王剣+3","見切り+4","見切り+5","攻撃力UP【特大】","攻撃力UP【絶大】","超高級耳栓","絶倫","狙い撃ち","体力+40","体力+50","業物+2","防御+90","防御+120","夏男夏女","冬将軍","砲術王","砲術神","圧力【大】","捕獲名人","集中+2","集中+1","雑念","片手剣技【剣聖】","片手剣技【皆伝】","片手剣技【達人】","片手剣技【未熟】","双剣技【双龍】","双剣技【皆伝】","双剣技【達人】","双剣技【未熟】","大剣技【剣王】","大剣技【皆伝】","大剣技【達人】","大剣技【未熟】","太刀技【刀神】","太刀技【皆伝】","太刀技【達人】","太刀技【未熟】","鎚技【鈍器獣】","鎚技【皆伝】","鎚技【達人】","鎚技【未熟】","狩猟笛技【奏帝】","狩猟笛技【皆伝】","狩猟笛技【達人】","狩猟笛技【未熟】","槍技【天槍】","槍技【皆伝】","槍技【達人】","槍技【未熟】","銃槍技【砲皇】","銃槍技【皆伝】","銃槍技【達人】","銃槍技【未熟】","重銃技【銃仙】","重銃技【皆伝】","重銃技【達人】","重銃技【未熟】","軽銃技【銃傑】","軽銃技【皆伝】","軽銃技【達人】","軽銃技【未熟】","弓技【弓鬼】","弓技【皆伝】","弓技【達人】","弓技【未熟】","暴風圧無効","耐震+2","罠師","罠匠","武器捌き","属性攻撃強化","属性攻撃弱化","スタミナ急速回復【大】","スタミナ急速回復【小】","スタミナ回復遅延","格闘王","強肩+2","スローイングナイフ+1","スローイングナイフ+2","いたわり+1","いたわり+2","いたわり+3","鉄面皮","剣術+1","剣術+2","状態異常半減","状態異常無効","状態異常倍加","片手剣技【大剣聖】","双剣技【大双龍】","大剣技【大剣王】","太刀技【大刀神】","鎚技【大鈍器獣】","狩猟笛技【大奏帝】","槍技【大天槍】","銃槍技【大砲皇】","重銃技【大銃仙】","軽銃技【大銃傑】","弓技【大弓鬼】","受け身+1","広域化+3","広域化-1","酒豪","酔っ払い","結晶耐性","結晶弱点","磁力耐性","磁力弱点","警戒","救援","尻上がり","一匹狼","代償","速射","砥匠","豪放+1","豪放+2","豪放+3","反射+1","反射+2","反射+3","真打+1","真打+2","真打+3","剛撃+1","剛撃+2","剛撃+3","剛撃+4","剛撃+5","激励+1","激励+2","恩寵+1","恩寵+2","恩寵+3","生命力+1","生命力+2","生命力+3","生命力-1","逆鱗","ブチギレ","鉄腕+1","鉄腕+2","ブリーダー","討ち返し+1","討ち返し+2","一閃+1","一閃+2","一閃+3","不屈","不撓不屈","剛弾+1","装着+1","装着+2","装着+3","痛撃","弱点特効","弱点苦手","調合師+1","調合師+2","調合師+3","調合師-1","ハンター生活","ハンター満喫","扇射+1","扇射+2","扇射+3","回避性能+3","移動速度UP+1","移動速度UP+2","節約名人","節約達人","溜め威力UP+1","溜め威力UP+2","回避距離UP","赤魂","青魂","吸血+1","吸血+2","適応撃+1","適応撃+2","最期ノ閃黒","薬仙人","穿龍棍技【穿凰】","穿龍棍技【皆伝】","穿龍棍技【達人】","穿龍棍技【未熟】","穿龍棍技【大穿凰】","煽動","紅焔の威光+1","紅焔の威光+2","劇物取扱皆伝","絶対防御態勢","盤石の構え","万全の備え","油断大敵","採集の極み","巧流","支援","反動軽減+3","穏射+1","穏射+2","穏射+3","属性特効","属性微効","闘覇","血気活性","血気活性+2","状態異常無効【多種】","剣神+1","剣神+2","纏雷","状態異常追撃","抜納術+1","抜納術+2","爆破耐性","閃転","閃転","不退ノ構","巧撃","凍結耐性","氷界創生","消費特効","剣斧技【斬将】","剣斧技【皆伝】","剣斧技【達人】","剣斧技【未熟】","剣斧技【大斬将】","要塞+1","要塞+2","狙撃","雌伏","超回避","猛進","激励+2","反射+3","腕利き","幕無","一点突破","怪奇","空隙","剛撃+6","剣神+3","剛弾+2","手練+1","手練+2","獅子奮迅","磁斬鎚技【磁星】","磁斬鎚技【皆伝】","磁斬鎚技【達人】","磁斬鎚技【未熟】","磁斬鎚技【大磁星】"
];
//関数
//検索用作成タイプ指定
...
for (var i = 0; i < 5; i++) { //部位別
	...
	if (eq[I_bCLASS]) {
		...
		if (eq[I_bCLASS] === "O") { //遷悠
			...
			var sen_skill_name = eq[I_bDOC].split("≪遷悠防具：")[1].split("≫")[0].replace("属性攻撃【","属性攻撃強化【");
