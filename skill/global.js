...
["狩猟",["BlizeGX","Ｔシャツ","King Beetle|Butterfly","ian ,Helper|Guild Guard,Healer","Guild Knight Red|Maid,Private","King Lobster","Black Belt","Jersey","Skull","Steel","Safety","Chainmail","Cat Piercings","High Metal","Hunter's","Battle","ピアス","Bistro","Belt","Bone","Hope","Makluva","Mafumofu","Metal","Melan","Melahoa","Rookie","Rouge","Leather","混沌","Shinobi","SP"].sort(function (a, b){return Fulltohalf(b) < Fulltohalf(a) ? 1 : -1}),
	...
	["クエスト",["Arc","Azul","アスハルテ","アナキ","Apkallu","アナトリ","Aruru","Iriku>Afti","Vol","Kakabu","Kukubo","コカロ","Gospel","Jess","Jyaga","Shasse","Death Stench","Noir","Rath Duo","ローク","Demon Lord|童子","Noon Glow|夕茜","Black Tiger|黒豹","刹帝利|婆羅門","Trancendant"," Ｇ貢献証"].sort(function (a, b){return Fulltohalf(b) < Fulltohalf(a) ? 1 : -1})],
	["謎クエスト",["Arietta>Tempest","ヴィリヴラ>Angriff","Vento>Mistral","ジスト","ディジ Gear>>Salvacion","Purogia>>ビステマ","Luxt","Royal>Lord","White Snake|White Bird"].sort(function (a, b){return Fulltohalf(b) < Fulltohalf(a) ? 1 : -1})],
...
["猟団",["Kirin","Corsage","Comrade","Comrade red Ｇ","Schutz>>Zwinger","Soldato>Gable","テネール","フェリ","Mixes","Ledia>Rurudi","狩人","眼鏡","猟団員"].sort(function (a, b){return Fulltohalf(b) < Fulltohalf(a) ? 1 : -1}),
	...
	["迎撃戦",["Myunru Ｚ","Fanru Ｚ","Shanru Z","Utatsumugu","Utante Z","Furante Z","Merente Z","Rikante Z","Utaei","Burning CliffＧ|Crimson CliffＧ","Katante Z"].sort(function (a, b){return Fulltohalf(b) < Fulltohalf(a) ? 1 : -1})]
],
["イベント",["Shandy","Banquet","Taruta","Guridi Ｚ","Elysi G","Shifunyi Z","Rapin G","Kashoku Ｚ","Aruganosu|Goruganosu","Kiyoshi Ｚ","Fonce G","Bonne G","Korinyi Z","DonruGX","Heruto Ｇ：Iroasu Ｇ","Demonclad Ｇ|Youthclad Ｇ","Rave","Marble","Cure","鬼凛 Ｇ|童凛 Ｇ","Rohokku","Red Cat テイル","Azul G","アトロ","ウナペルト","Excelle","Otono","Oleum","Kaioru","Anteka","Ganeto","Kalais","キノス系","Kirin Corno","Quoiz","グラッシュ","Craft","Kuranto","Coord","Shimashima","Shell カ","Shirukku","Strength","Santa","Shiusu Ｇ","Shieri","Jess G","Suforu","Tangusu|Kobaruta","Tangusu G |Kobaruta Ｇ","Chiru G","チャチャ","チャーム系","Dogumea","トリート","Harvest>Freyja","フレイ>>コピアイ","High Metal Ｕ","Harubadaa |Tracker","Beretta","Harokyu","Piercings(ｲﾍﾞﾝﾄ)","Piercings(書物)","Piercings(海陸空)","Piercings(ビギナー)","Piercings(封印石)","Mask","Buran","Furogada G","Moss Cover","Yurisu","Yupuk","Lars","Rance","Riaruo","Lucchese","Luchar","Reiresu G","Reuasu G","ロ Black Blos|ライード","Blue Sky|Welkin","Valued Word|式部","Demon Lord|童子","Demon Tale Ｇ|童伝 Ｇ","若紅葉|翡戸隠","Pale Sakura|Sakura Cloud","Crushing Fog|Fog"].sort(function (a, b){return Fulltohalf(b) < Fulltohalf(a) ? 1 : -1}),
	["韋駄天",["Patapatagook","Barrel Cat","Tandress"].sort(function (a, b){return Fulltohalf(b) < Fulltohalf(a) ? 1 : -1})]
],
["ネカフェ",["Ruruta","アデュス>デュスノ","Amitie>Pistis","Embrace","Orden>Orutemo","Kaila","Gagachu","Kyuura","Jumpin'>Blink","スフレ","Solene","Desert","トイスト","Trance","トロピオ","Magisa>>Buruho|Wizard>>マー Gear","Lapine","リエーザ>Risaaza","ルクス>Lucis","Regis>Regyukusu","Wagune"].sort(function (a, b){return Fulltohalf(b) < Fulltohalf(a) ? 1 : -1}),
