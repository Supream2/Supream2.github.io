...
["イベント",["Shandy","Banquet","Taruta","Guridi Ｚ","Elysi G","Shifunyi Z","Rapin G","Kashoku Ｚ","Aruganosu|Goruganosu","Kiyoshi Ｚ","Fonce G","Bonne G","KorinyiZ","DonruGX","Heruto Ｇ：Iroasu Ｇ","Demonclad Ｇ|Youthclad Ｇ","Rave","Marble","Cure","鬼凛 Ｇ|童凛 Ｇ","Rohokku","Red Cat テイル","Azul G","アトロ","ウナペルト","Excelle","Otono","Oleum","Kaioru","Anteka","Ganeto","Kalais","キノス系","Kirin Corno","Quoiz","グラッシュ","Craft","Kuranto","Coord","Shimashima","Shell カ","Shirukku","Strength","Santa","Shiusu Ｇ","Shieri","Jess G","Suforu","Tangusu|Kobaruta","Tangusu G |コバルタ Ｇ","Chiru G","チャチャ","チャーム系","Dogumea","トリート","ハーヴェスト>>コピアイ","ハイメタＵ","Harubadaa |トラッカー","バレッタ","Harokyu","ピアス(ｲﾍﾞﾝﾄ)","ピアス(書物)","ピアス(海陸空)","ピアス(ビギナー)","ピアス(封印石)","フェイク","Buran","Furogada G","モスカバ","ユーリス","Yupuk","Lars","ランセ","リアルオ","Lucchese","Luchar","Reiresu G","Reuasu G","ロアース|ライード","Blue Sky|蒼天","納言|式部","Demon Lord|童子","Demon Tale Ｇ|童伝 Ｇ","若紅葉|翡戸隠","Pale Sakura|桜雲","崩霧|迅霧"].sort(function (a, b){return Fulltohalf(b) < Fulltohalf(a) ? 1 : -1}),
