...
if (MST_Other.Cyougo[item_id]) {
	var JijiMeiKoukan = [" Exchange with 「トッテオキ」 with high probability"," Exchange with 「オタカラ」 with high probability"," Exchange with High chance"," Exchange with Low chance"," Exchange with"],
