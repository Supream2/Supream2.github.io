...
INFO[10].Bullet = {
//N:名前,P:威力,C:コメント
			"Rpd1":{N:"連射LV1",P:[12],C:"|12"},
			"Rpd2":{N:"連射LV2",P:[12,5],C:"|12-5"},
			"Rpd3":{N:"連射LV3",P:[12,5,4],C:"|12-5-4"},
			"Rpd4":{N:"連射LV4",P:[12,5,4,2],C:"|12-5-4-2"},
			"Spr1":{N:"拡散LV1",P:[5,4],C:"|4-5-4"},
			"Spr2":{N:"拡散LV2",P:[6,5],C:"|5-6-5"},
			"Spr3":{N:"拡散LV3",P:[5,4],C:"|4-5-5-5-4"},
			"Spr4":{N:"拡散LV4",P:[6,5,4],C:"|4-5-6-5-4"},
			"Prc1":{N:"貫通LV1",P:[6],C:"|6x3回"},
			"Prc2":{N:"貫通LV2",P:[6],C:"|6x4回"},
			"Prc3":{N:"貫通LV3",P:[6],C:"|6x5回"},
			"Prc4":{N:"貫通LV4",P:[6],C:"|6x6回"},
